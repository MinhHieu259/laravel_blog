            ...
            <div class="modal-content">
               <form action="{{url('admin/delete-category')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <h5>Are you sure to delete this Category with all its post ?</h5>
                </div>
                            ...
                            @foreach ($category as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button data-bs-toggle="modal" data-bs-target="#deleteModal" type="button" class="btn btn-danger deleteCategoryBtn"
